...
class MyHomePage extends StatefulWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // This method is rerun every time setState is called, f or instance as done
...
class PeopleList extends StatelessWidget {
  List <Map> fetchPeople(){
    return[
      ...
      {"first":"Johnney", "last":"Depp"},
      {"first":"Tom", "last":"Cruise"},
      {"first":"Lin", "last":"Woodbug"},
      {"first":"Son", "last":"Heongmin"},
      {"first":"Jim", "last":"Carry"},
      {"first":"Lion", "last":"Laynolse"},
      {"first":"John", "last":"Jin"},
    ];
  }
@override
